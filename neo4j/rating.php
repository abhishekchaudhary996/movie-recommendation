	...
	<html >
  	...
  	<body>
  		<div class="container-fluid">
  			...
  			<div class="row">
  				<h1> <center> Your Rating</center> </h1> (give rating out of 10) </center> 
  			</div>
  			...
  			<div class="row">
  				<div class="col-md-6" >
  					Movie Title : <?php echo $movie; ?>
  					<form action="rated.php" method="get">
  						<input type="text" name="movie_name" placeholder="Enter Movie Name"><br>
  						<input type="text" name="rate" placeholder="rating out of 10(integer)"><br>
